...
library(plotly)
g <- ggplot(cars, aes(speed, dist)) + geom_point()
widgetframe::frameWidget(ggplotly(g), height = 270, width = 300)
```
...
For continued learning (all accessible free online)
...
`>` Download the zip file [here](https://github.com/emitanaka/EDVR-workshop/archive/refs/heads/master.zip)  
