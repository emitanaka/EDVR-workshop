...
pagetitle: "Elements of effective data visualisation"
author: "Emi Tanaka"
...
dfsex <- edvr.workshop::census_bpsex %>% 
  filter(!birth %in% c("Total")) %>% 
  filter(!birth %in% c("Not Stated", "Other", "Australia")) %>% 
...
* enhance the message, and
* should be [aesthetically pleasing]{.monash-blue}.
...
Wilke, Claus (2019) Fundamentals of Data Visualization: A Primer on Making Informative and Compelling Figures. O'Reily.

:::

## [Human cognition]{.monash-blue} framework for data visualisation

<center>
![](images/human-cognition.svg){width="65%"}
</center>

::: aside

Patterson, Robert E., Leslie M. Blaha, Georges G. Grinstein, Kristen K. Liggett, David E. Kaveney, Kathleen C. Sheldon, Paul R. Havig, and Jason A. Moore. 2014. “A Human Cognition Framework for Information Visualization.” Computers & Graphics 42 (August): 42–58.

:::

## 3D pie chart is a "bad plot"
...
Healey, Christopher G. 1992. “Visualization of Multivariate Data Using Preattentive Processing.” Masters Thesis. University of British Columbia.

:::

## Color to [distinguish]{.monash-blue} 
...
## Color to [highlight]{.monash-blue} 


```{r highlight}
ggplot(economics_long, aes(date, value)) +
  geom_line() +
  geom_line(data = ~filter(., variable=="unemploy"),
            color = "red") +
...
* Mind perceives objects as symmetrical centred around a center point.

## Law of continuity

![](images/gestalt-continuity.svg)


. . . 

* Objects are perceived as a whole if certain elements are grouped together.
...
<iframe src="datastory1.html" width="100%" height="600px" style="border: 2px solid black;"></iframe>

## Data story example: birth place, another look

<iframe src="datastory2.html" width="100%" height="600px" style="border: 2px solid black;"></iframe>
